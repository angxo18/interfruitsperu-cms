...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="emerald">
  ...
  --}}
	...
	<body>
		...
		<footer class="bg-zinc-800 text-gray-300 py-10">
			<div class="max-w-7xl mx-auto px-6 lg:px-8">
				<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
					...
					<div>
						...
						<p class="text-sm">
							Calidad que cruza fronteras. Exportamos frutas frescas y ofrecemos
							servicios de empacado desde nuestras sedes en Perú.
						</p>
					</div>
					...
					<div>
						...
						<ul class="space-y-2 text-sm">
							...
							<li>
								<a href="{{ route('products') }}" class="hover:text-white">
									Productos
								</a>
							</li>
							<li>
					...
					<div>
						...
						<p class="text-sm mb-3">
							...
							Carretera Tambo Grande - Las Lomas Km. 1078 + 030, Tambo Grande - Piura,
							Perú
						</p>
						<p class="text-sm mb-3">
							<x-lucide-map-pin class="w-5 h-5 inline-block text-gray-200" />
							<span class="font-semibold">Sullana:</span>
							Carretera Tambo Grande RRCC 418 No. 95 Cas. Huangala, Sullana-Piura,
							Perú
						</p>
					</div>
